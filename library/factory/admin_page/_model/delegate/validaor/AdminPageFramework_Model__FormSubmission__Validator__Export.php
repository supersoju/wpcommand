...
class WPCAC_AdminPageFramework_Model__FormSubmission__Validator__Export extends WPCAC_AdminPageFramework_Model__FormSubmission__Validator__Import {
    ...
    {
        $_oExport = new WPCAC_AdminPageFramework_ExportOptions($this->getHTTPRequestSanitized($this->getElementAsArray($_POST, array( '__export' ))), $this->oFactory->oProp->sClassName);
