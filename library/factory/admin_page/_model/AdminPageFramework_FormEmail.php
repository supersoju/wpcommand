...
class WPCAC_AdminPageFramework_FormEmail extends WPCAC_AdminPageFramework_FrameworkUtility {
    ...
    public function send()
    {
        ...
        do_action('wpcommand_action_before_sending_form_email', $_aEmailOptions, $_aInputs, $_sSubmitSectionID);
        ...
        do_action('wpcommand_action_after_sending_form_email', $_bSent, $_aEmailOptions);
    ...
    public function _replyToSetEmailSenderAddress($sEmailSenderAddress)
    {
        return $this->_sEmailSenderAddress;
    }
    public function _replyToSetEmailSenderName($sEmailSenderAddress)
    {
