...
class WPCAC_AdminPageFramework_ExportOptions extends WPCAC_AdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
    ...
    private function _outputDataByType($vData, $sFormatType)
    {
        switch (strtolower($sFormatType)) { case 'text': if (in_array(gettype($vData), array( 'array', 'object' ))) {
            echo WPCAC_AdminPageFramework_Debug::get($vData, null, false);
