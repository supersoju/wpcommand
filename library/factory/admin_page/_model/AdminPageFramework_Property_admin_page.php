...
class WPCAC_AdminPageFramework_Property_admin_page extends WPCAC_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability='manage_options', $sTextDomain='wpcommand')
    {
        ...
        $GLOBALS[ 'aWPCAC_AdminPageFramework' ][ 'aPageClasses' ] = $this->getElementAsArray($GLOBALS, array( 'aWPCAC_AdminPageFramework', 'aPageClasses' ));
        $GLOBALS[ 'aWPCAC_AdminPageFramework' ][ 'aPageClasses' ][ $sClassName ] = $oCaller;
    ...
    {
        switch ($sOptionType) { default: case 'options_table': return $this->sOptionKey ? $this->getAsArray(get_option($this->sOptionKey, array())) : array(); case 'transient': return $this->getAsArray($this->getTransient($this->sOptionKey, array())); }
    }
    ...
    {
        switch ($sOptionType) { default: case 'options_table': return update_option($this->sOptionKey, $aOptions); case 'transient': return $this->setTransient($this->sOptionKey, $aOptions, $this->iOptionTransientDuration); }
    }
