...
abstract class WPCAC_AdminPageFramework_Router extends WPCAC_AdminPageFramework_Factory {
    public $oProp;
    public $oForm;
    ...
    public function _replyToLoadComponentsForAjax()
    {
        ...
        new WPCAC_AdminPageFramework_Model_Menu__RegisterMenu($this, 'pseudo_admin_menu');
