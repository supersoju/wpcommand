...
class WPCAC_AdminPageFramework_View__Resource extends WPCAC_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    {
        $_oFormatter = new WPCAC_AdminPageFramework_Format_PageResource_Style($asPageStyle);
    ...
    {
        $_oFormatter = new WPCAC_AdminPageFramework_Format_PageResource_Script($asPageScript);
