...
class WPCAC_AdminPageFramework_View__PageRenderer__PageHeadingTabs extends WPCAC_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    public $sPageSlug;
    public $sTag = 'h2';
    ...
    {
        $_oTabBar = new WPCAC_AdminPageFramework_TabNavigationBar($aPages, $sCurrentPageSlug, $sTag, array( ), array( 'format' => array( $this, '_replyToFormatNavigationTabItem_PageHeadingTab' ), ));
        $_sTabBar = $_oTabBar->get();
        return $_sTabBar ? "<div class='wpcommand-page-heading-tab'>" . $_sTabBar . "</div>" : '';
    }
    public function _replyToFormatNavigationTabItem_PageHeadingTab($aSubPage, $aStructure, $aPages, $aArguments=array())
    {
        switch ($aSubPage['type']) { case 'link': return $this->_getFormattedPageHeadingtabNavigationBarLinkItem($aSubPage, $aStructure); default: return $this->_getFormattedPageHeadingtabNavigationBarPageItem($aSubPage, $aStructure); }
