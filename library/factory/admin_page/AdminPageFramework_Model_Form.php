...
abstract class WPCAC_AdminPageFramework_Model_Form extends WPCAC_AdminPageFramework_Router {
    public $aFieldErrors;
    ...
    {
        new WPCAC_AdminPageFramework_Model__FormSubmission($this, $aSavedData, $aArguments, $aSectionsets, $aFieldsets);
    }
