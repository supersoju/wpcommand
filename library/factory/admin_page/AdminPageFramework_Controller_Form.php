...
abstract class WPCAC_AdminPageFramework_Controller_Form extends WPCAC_AdminPageFramework_View_Form {
    ...
    public function getValue()
    {
        ...
        return WPCAC_AdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, empty($_aParams) ? null : $_aDimensionalKeys, $_mDefault, $this->getSavedOptions() + $this->oForm->getDefaultFormValues());
    }
