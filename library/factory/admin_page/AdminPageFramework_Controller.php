...
abstract class WPCAC_AdminPageFramework_Controller extends WPCAC_AdminPageFramework_View {
    ...
    public function setAdminNotice($sMessage, $sClassSelector='error', $sID='')
    {
        ...
        new WPCAC_AdminPageFramework_AdminNotice($this->oProp->aAdminNotices[ $sID ][ 'sMessage' ], $this->oProp->aAdminNotices[ $sID ][ 'aAttributes' ], array( 'should_show' => array( $this, 'isInThePage' ), ));
    }
    ...
    {
        return WPCAC_AdminPageFramework_WPUtility::getOption($sOptionKey, $asKey, $vDefault);
    }
}
