...
abstract class WPCAC_AdminPageFramework_MetaBox_Model extends WPCAC_AdminPageFramework_MetaBox_Router {
    ...
    {
        $_oMetaData = new WPCAC_AdminPageFramework_MetaBox_Model___PostMeta($this->___getPostID(), $this->oForm->aFieldsets);
