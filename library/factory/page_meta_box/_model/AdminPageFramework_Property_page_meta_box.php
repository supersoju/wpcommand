...
class WPCAC_AdminPageFramework_Property_page_meta_box extends WPCAC_AdminPageFramework_Property_post_meta_box {
    ...
    public function __construct($oCaller, $sClassName, $sCapability='manage_options', $sTextDomain='wpcommand', $sStructureType='page_meta_box')
    {
        unset($this->oAdminPage, $this->aHelpTabs);
        parent::__construct($oCaller, $sClassName, $sCapability, $sTextDomain, $sStructureType);
        $GLOBALS[ 'aWPCAC_AdminPageFramework' ][ 'aMetaBoxForPagesClasses' ] = $this->getElementAsArray($GLOBALS, array( 'aWPCAC_AdminPageFramework', 'aMetaBoxForPagesClasses' ));
        $GLOBALS[ 'aWPCAC_AdminPageFramework' ][ 'aMetaBoxForPagesClasses' ][ $sClassName ] = $oCaller;
    }
    ...
    {
        $_aPageClasses = $this->getElementAsArray($GLOBALS, array( 'aWPCAC_AdminPageFramework', 'aPageClasses' ));
