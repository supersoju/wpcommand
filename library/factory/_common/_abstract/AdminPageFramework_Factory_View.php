...
abstract class WPCAC_AdminPageFramework_Factory_View extends WPCAC_AdminPageFramework_Factory_Model {
    public function __construct($oProp)
    {
        parent::__construct($oProp);
        new WPCAC_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
