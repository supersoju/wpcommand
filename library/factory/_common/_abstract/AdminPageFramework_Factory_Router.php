...
abstract class WPCAC_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array( 'oForm' => 'WPCAC_AdminPageFramework_Form_', 'oPageLoadInfo' => 'WPCAC_AdminPageFramework_PageLoadInfo_', 'oResource' => 'WPCAC_AdminPageFramework_Resource_', 'oHelpPane' => 'WPCAC_AdminPageFramework_HelpPane_', 'oLink' => 'WPCAC_AdminPageFramework_Link_', );
    private $_aSubClassNames = array( 'oProp' => null, 'oDebug' => 'WPCAC_AdminPageFramework_Debug', 'oUtil' => 'WPCAC_AdminPageFramework_FrameworkUtility', 'oMsg' => 'WPCAC_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null, );
    ...
    {
        trigger_error(WPCAC_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString()
    {
        return WPCAC_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
