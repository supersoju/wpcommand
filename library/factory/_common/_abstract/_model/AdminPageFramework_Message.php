 ...
 * @package  WPCAC_AdminPageFramework/Common/Factory/Property
 * @internal
 ...
 */
class WPCAC_AdminPageFramework_Message {
     ...
     *      'foo'  => __( 'Foo', 'wpcommand' ),
     *      'bar'  => __( 'Bar', 'wpcommand' ),
     *       ... more 100 items
     * )
    ...
    public $aDefaults = array(
        ...
        // WPCAC_AdminPageFramework_PostType
        'title'                                 => 'Title',
        'author'                                => 'Author',
        ...
        // WPCAC_AdminPageFramework_Link_Base
        'powered_by'                            => 'Thank you for creating with',
        'and'                                   => 'and',

        // WPCAC_AdminPageFramework_Link_admin_page
        'settings'                              => 'Settings',

        // WPCAC_AdminPageFramework_Link_post_type
        'manage'                                => 'Manage',

        // WPCAC_AdminPageFramework_FieldType_{...}
        ...
        // WPCAC_AdminPageFramework_Form_View___Script_{...}
        'select'                                => 'Select', // 3.4.2+
        'insert'                                => 'Insert',  // 3.4.2+
        'use_this'                              => 'Use This', // 3.4.2+
        'return_to_library'                     => 'Return to Library', // 3.4.2+

        // WPCAC_AdminPageFramework_PageLoadInfo_Base
        ...
        // WPCAC_AdminPageFramework_FormField
        ...
        // WPCAC_AdminPageFramework_FormPart_Table
        ...
        // WPCAC_AdminPageFramework_FieldType_reset 3.3.0+
        'reset'                                 => 'Reset',

        // WPCAC_AdminPageFramework_FieldType_system 3.5.3+
        'yes'                                   => 'Yes',
        'no'                                    => 'No',
        'on'                                    => 'On',
        'off'                                   => 'Off',
        ...
        // 3.7.0+ - accessed from `WPCAC_AdminPageFramework_Form`
        'method_called_too_early'               => 'The method is called too early.',

        // 3.7.0+  - accessed from `WPCAC_AdminPageFramework_Form_View___DebugInfo`
     ...
     */
    protected $_sTextDomain = 'wpcommand';
     ...
     * @return      WPCAC_AdminPageFramework_Message
     */
    public static function getInstance( $sTextDomain='wpcommand' ) {

        $_oInstance = isset( self::$_aInstancesByTextDomain[ $sTextDomain ] ) && ( self::$_aInstancesByTextDomain[ $sTextDomain ] instanceof WPCAC_AdminPageFramework_Message )
            ? self::$_aInstancesByTextDomain[ $sTextDomain ]
            : new WPCAC_AdminPageFramework_Message( $sTextDomain );
         ...
         * @deprecated  3.2.0
         */
        public static function instantiate( $sTextDomain='wpcommand' ) {
     ...
     * @param string $sTextDomain
     */
    public function __construct( $sTextDomain='wpcommand' ) {
