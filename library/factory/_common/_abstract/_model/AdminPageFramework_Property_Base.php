...
abstract class WPCAC_AdminPageFramework_Property_Base extends WPCAC_AdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType)
    {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'wpcommand' : $sTextDomain;
    ...
    {
        if (! isset($GLOBALS[ 'aWPCAC_AdminPageFramework' ])) {
            $GLOBALS[ 'aWPCAC_AdminPageFramework' ] = array( 'aFieldFlags' => array() );
        }
    }
    ...
    {
        self::$_aLibraryData = array( 'sName' => WPCAC_AdminPageFramework_Registry::NAME, 'sURI' => WPCAC_AdminPageFramework_Registry::URI, 'sScriptName' => WPCAC_AdminPageFramework_Registry::NAME, 'sLibraryName' => WPCAC_AdminPageFramework_Registry::NAME, 'sLibraryURI' => WPCAC_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => WPCAC_AdminPageFramework_Registry::getVersion(), 'sDescription' => WPCAC_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => WPCAC_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => WPCAC_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => WPCAC_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => WPCAC_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '', );
    ...
    public function __get($sName)
    {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new WPCAC_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
}
