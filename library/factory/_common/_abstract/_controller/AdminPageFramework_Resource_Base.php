...
abstract class WPCAC_AdminPageFramework_Resource_Base extends WPCAC_AdminPageFramework_FrameworkUtility {
    ...
    protected $_sClassSelector_Style = 'wpcommand-style';
    protected $_sClassSelector_Script = 'wpcommand-script';
    ...
    {
        $_sStyleIE = $this->addAndApplyFilters($oCaller, array( "style_ie_common_admin_page_framework", "style_ie_common_{$this->oProp->sClassName}", ), WPCAC_AdminPageFramework_CSS::getDefaultCSSIE());
    ...
    protected function _printCommonScripts($sIDPrefix, $sClassName)
    {
        ...
        $_sScript = $this->addAndApplyFilters($this->oProp->oCaller, array( "script_common_admin_page_framework", "script_common_{$this->oProp->sClassName}", ), WPCAC_AdminPageFramework_Property_Base::$_sDefaultScript);
    ...
    public function _replyToAddStyle()
    {
        ...
        $this->_printCommonStyles('wpcommand-style-common', get_class());
    ...
    public function _replyToAddScript()
    {
        ...
        $this->_printCommonScripts('wpcommand-script-common', get_class());
    ...
    public function _replyToEnqueueCommonStyles()
    {
        ...
        $this->_addEnqueuingResourceByType(WPCAC_AdminPageFramework_Registry::$sDirPath . '/factory/_common/asset/css/common.css', array( 'version' => WPCAC_AdminPageFramework_Registry::VERSION, ), 'style');
    }
