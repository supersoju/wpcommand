...
var apfMedia = WPCAC_AdminPageFrameworkMediaFieldType;
apfMedia.hasMediaUploader = !! apfMedia.hasMediaUploader;

(function ( $ ) {

  debugLog( '0.1.0', apfMedia );

  var setWPCAC_AdminPageFrameworkMediaUploader;
  ...
  $( document ).ready( function () {
    ...
    if ( ! apfMedia.hasMediaUploader ) {
       ...
       */
      setWPCAC_AdminPageFrameworkMediaUploader = function ( sInputID, bMultiple, fExternalSource ) {
        ...
        _oSelectMedia.on( 'click', function () {
          ...
          window.send_to_editor = hfWPCAC_AdminPageFrameworkSendToEditorMedia;
      ...
      var hfWPCAC_AdminPageFrameworkSendToEditorMedia = function ( sRawHTML, param ) {
      ...
      setWPCAC_AdminPageFrameworkMediaUploader = function ( sInputID, bMultiple, fExternalSource ) {
        ...
        _oSelectMediaButton.on( 'click', function ( e ) {
          ...
          oWPCAC_AdminPageFrameworkOriginalMediaUploaderSelectObject = wp.media.view.MediaFrame.Select;

          // Assign a custom select object.
          wp.media.view.MediaFrame.Select = fExternalSource ? getWPCAC_AdminPageFrameworkCustomMediaUploaderSelectObject() : oWPCAC_AdminPageFrameworkOriginalMediaUploaderSelectObject;
          ...
          _oMediaUploader.on( 'close', function () {
            ...
            if ( typeof (_oMedia) !== 'undefined' ) {
              ...
              _oMediaUploader.state().get( 'selection' ).each( function ( oAttachment, iIndex ) {
                ...
                var _oFieldContainer = 'undefined' === typeof _oNewField
                  ? $( '#' + sInputID ).closest( '.wpcommand-field' )
                  : _oNewField;
                _oNewField = $( this ).addWPCAC_AdminPageFrameworkRepeatableField( _oFieldContainer.attr( 'id' ) );
            ...
            wp.media.view.MediaFrame.Select = oWPCAC_AdminPageFrameworkOriginalMediaUploaderSelectObject;
    ...
    $( document ).ready( function () {
      ...
      $( 'a.select_media.button' ).each( function() {
        setWPCAC_AdminPageFrameworkMediaUploader( $( this ).data( 'input_id' ), $( this ).data( 'repeatable' ), $( this ).data( 'enable_external_source' ) );
      } );
      ...
      $().registerWPCAC_AdminPageFrameworkCallbacks( {
          ...
          repeated_field: function ( oCloned, aModel ) {
            ...
            setWPCAC_AdminPageFrameworkMediaUploader(
