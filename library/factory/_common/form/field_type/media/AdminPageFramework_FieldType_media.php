...
class WPCAC_AdminPageFramework_FieldType_media extends WPCAC_AdminPageFramework_FieldType_image {
    ...
    {
        return array( array( 'handle_id' => 'wpcommand-field-type-media', 'src' => dirname(__FILE__) . '/js/media.bundle.js', 'in_footer' => true, 'dependencies' => array( 'jquery', 'wpcommand-script-form-main' ), 'translation_var' => 'WPCAC_AdminPageFrameworkMediaFieldType', 'translation' => array( 'fieldTypeSlugs' => $this->aFieldTypeSlugs, 'referer' => 'admin_page_framework', 'hasMediaUploader' => function_exists('wp_enqueue_media'), 'label' => array( 'uploadFile' => $this->oMsg->get('upload_file'), 'useThisFile' => $this->oMsg->get('use_this_file'), 'insertFromURL' => $this->oMsg->get('insert_from_url'), ), ), ), );
    }
