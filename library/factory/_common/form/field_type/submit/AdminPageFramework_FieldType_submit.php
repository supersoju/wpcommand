...
class WPCAC_AdminPageFramework_FieldType_submit extends WPCAC_AdminPageFramework_FieldType {
    ...
    {
        return array( array( 'handle_id' => 'wpcommand-submit-field-type', 'src' => dirname(__FILE__) . '/js/submit.bundle.js', 'in_footer' => true, 'dependencies' => array( 'jquery', ), ), );
    }
    ...
    {
        return array( 'style' => $aField[ 'label_min_width' ] || '0' === ( string ) $aField[ 'label_min_width' ] ? "min-width:" . $this->getLengthSanitized($aField[ 'label_min_width' ]) . ";" : null, 'class' => 'wpcommand-input-label-container' . ' wpcommand-input-button-container' . ' wpcommand-input-container', );
    }
