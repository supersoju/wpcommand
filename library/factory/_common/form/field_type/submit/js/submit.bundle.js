...
(function($){
  ...
  $( document ).ready( function(){
    ...
    $( '.wpcommand-field-submit .submit-confirm-container input[type=checkbox]' ).each( function( index, value ){
      $( this ).closest( '.wpcommand-field-submit' ).find( 'input[type=submit]' ).on( 'click', function( event ){
        var _fieldSubmit = $( this ).closest( '.wpcommand-field-submit' );
        _fieldSubmit.find( '.submit-confirmation-warning' ).remove(); // previous error message
        var _confirmCheckbox = $( this ).closest( '.wpcommand-field-submit' ).find( '.submit-confirm-container input[type=checkbox]' );
