...
class WPCAC_AdminPageFramework_FieldType__nested extends WPCAC_AdminPageFramework_FieldType {
    ...
    protected function getField($aField)
    {
        ...
        foreach ($this->getAsArray($aField[ 'content' ]) as $_aChildFieldset) {
            ...
            $_oFieldset = new WPCAC_AdminPageFramework_Form_View___Fieldset($_aChildFieldset, $_oCallerForm->aSavedData, $_oCallerForm->getFieldErrors(), $_oCallerForm->aFieldTypeDefinitions, $_oCallerForm->oMsg, $_oCallerForm->aCallbacks);
