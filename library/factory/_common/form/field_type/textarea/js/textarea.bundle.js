...
(function($){
  ...
  /** global: WPCAC_AdminPageFrameworkFieldTypeTextArea */
  var apfTextArea = WPCAC_AdminPageFrameworkFieldTypeTextArea;
  ...
  $( document ).ready( function(){
    ...
    var updateFoundEditors = function ( oElements ) {
      ...
      oElements.each( function ( iIndex ) {
        ...
        var oSettings = $().getWPCAC_AdminPageFrameworkInputOptions( oWrap.attr( 'data-id' ) );
    ...
    $().registerWPCAC_AdminPageFrameworkCallbacks( {
        ...
        repeated_field: function ( oCloned, aModel ) {
          ...
          var _oSettings = $().getWPCAC_AdminPageFrameworkInputOptions( _oWrap.attr( 'data-id' ) );

          // Elements
          var _oField = oCloned.closest( '.wpcommand-field' );
        ...
        stopped_sorting_fields: function ( oSortedFields, sFieldType, sFieldsTagID, iCallType ) {
          ...
          // Update the editor.
          setTimeout( function () {
            var _oFields = oSortedFields.children( '.wpcommand-field' );
        ...
        stopped_sorting_sections: function ( oSections ) {
          ...
          setTimeout( function () {
            var _oFields = $( oSections ).find( '.wpcommand-field' );
            updateFoundEditors( _oFields );
          }, 100 );
        ...
        saved_widget: function ( oWidget ) {
          ...
          $( oWidget ).find( '.wpcommand-field' ).each( function ( iIndex ) {
            ...
            // Store the settings.
            $().storeWPCAC_AdminPageFrameworkInputOptions(
              oWrap.attr( 'data-id' ),
              {
    ...
    // Initialize
    $( '.wpcommand-textarea-data-input' ).each( function(){
