...
(function ( $ ) {
  ...
  var apfColor = WPCAC_AdminPageFrameworkColorFieldType;

  var registerWPCAC_AdminPageFrameworkColorPickerField = function ( osSubjectInput, aOptions ) {
    ...
    var _aDefaults = {
      ...
      change: function ( event, ui ) {
        $( osTargetInput ).trigger( 'wpcommand_field_type_color_changed' );
      ...
      clear: function ( event, ui ) {
        $( osTargetInput ).trigger( 'wpcommand_field_type_color_cleared' );
  ...
  $( document ).ready( function () {
    ...
    // Initialization
    $( '.wpcommand-field-color-picker' ).each( function () {
      registerWPCAC_AdminPageFrameworkColorPickerField( $( this ).data( 'input_id' ) );
    } );
    ...
    $().registerWPCAC_AdminPageFrameworkCallbacks( {
        ...
        repeated_field: function ( oCloned, aModel ) {
          ...
          oCloned.find( 'input.input_color' ).each( function ( iIterationIndex ) {
            ...
            registerWPCAC_AdminPageFrameworkColorPickerField( _oNewColorInput );
