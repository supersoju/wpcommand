...
(function($){
  ...
  var apfCheckBox = WPCAC_AdminPageFrameworkFieldTypeCheckbox;
  ...
  $( document ).ready( function(){
    ...
    $( document ).ready( function(){
      ...
      _body.on( 'click', '.select_all_button_container', function() {
        $( this ).selectAllWPCAC_AdminPageFrameworkCheckboxes();
        return false;
      } );
      ...
      _body.on( 'click', '.select_none_button_container', function() {
        $( this ).deselectAllWPCAC_AdminPageFrameworkCheckboxes();
        return false;
      } );
    });
