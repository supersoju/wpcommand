...
var apfImage = WPCAC_AdminPageFrameworkImageFieldType;
apfImage.hasMediaUploader = !! apfImage.hasMediaUploader;
(function ( $ ) {

  var setWPCAC_AdminPageFrameworkImageUploader;
  ...
  $( document ).ready( function () {
    ...
    if ( ! apfImage.hasMediaUploader ) {
       ...
       */
      setWPCAC_AdminPageFrameworkImageUploader = function ( sInputID, fMultiple, fExternalSource ) {
        ...
        _oSelectImage.on( 'click', function () {
          ...
          window.send_to_editor = hfWPCAC_AdminPageFrameworkSendToEditorImage;
      ...
      var hfWPCAC_AdminPageFrameworkSendToEditorImage = function ( sRawHTML ) {
      ...
      setWPCAC_AdminPageFrameworkImageUploader = function ( sInputID, fMultiple, fExternalSource ) {
        ...
        _oSelectImage.on( 'click', function ( e ) {
          ...
          oWPCAC_AdminPageFrameworkOriginalImageUploaderSelectObject = wp.media.view.MediaFrame.Select;
          // Assign a custom select object
          wp.media.view.MediaFrame.Select = fExternalSource ? getWPCAC_AdminPageFrameworkCustomMediaUploaderSelectObject() : oWPCAC_AdminPageFrameworkOriginalImageUploaderSelectObject;
          ...
          _oCustomImageUploader.on( 'close', function () {
            ...
            wp.media.view.MediaFrame.Select = oWPCAC_AdminPageFrameworkOriginalImageUploaderSelectObject;
    ...
    $().registerWPCAC_AdminPageFrameworkCallbacks( {
        ...
        repeated_field: function ( oCloned, aModel ) {
          ...
          // Bind the event.
          var _oFieldContainer = oCloned.closest( '.wpcommand-field' );
          ...
          setWPCAC_AdminPageFrameworkImageUploader(
    ...
    $( '.select_image.button' ).each( function() {
      setWPCAC_AdminPageFrameworkImageUploader( $( this ).data( 'input_id' ), $( this ).data( 'repeatable' ), $( this ).data( 'enable_external_source' ) );
    } );
    // Remove buttons
