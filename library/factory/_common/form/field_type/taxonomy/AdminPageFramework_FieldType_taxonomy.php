...
class WPCAC_AdminPageFramework_FieldType_taxonomy extends WPCAC_AdminPageFramework_FieldType_checkbox {
    ...
    {
        return array( array( 'handle_id' => 'wpcommand-field-type-taxonomy', 'src' => dirname(__FILE__) . '/js/taxonomy.bundle.js', 'in_footer' => true, 'dependencies' => array( 'jquery', 'wpcommand-script-form-main' ), 'translation_var' => 'WPCAC_AdminPageFrameworkFieldTypeTaxonomy', 'translation' => array( 'fieldTypeSlugs' => $this->aFieldTypeSlugs, 'label' => array(), ), ), );
    }
