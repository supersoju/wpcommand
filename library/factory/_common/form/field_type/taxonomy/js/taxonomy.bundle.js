...
(function($){
  ...
  var apfTaxonomy = WPCAC_AdminPageFrameworkFieldTypeTaxonomy;
  ...
  $( document ).ready( function(){
    ...
    /* For tabs */
    var enableWPCAC_AdminPageFrameworkTabbedBox = function ( nodeTabBoxContainer ) {
    ...
    enableWPCAC_AdminPageFrameworkTabbedBox( $( '.tab-box-container' ) );
    ...
    $().registerWPCAC_AdminPageFrameworkCallbacks( {
        ...
        repeated_field: function ( oCloned, aModel ) {
          ...
          // Initialize
          enableWPCAC_AdminPageFrameworkTabbedBox( oCloned.find( '.tab-box-container' ) );
