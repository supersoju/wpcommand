...
abstract class WPCAC_AdminPageFramework_Form_View___Fieldset_Base extends WPCAC_AdminPageFramework_Form_Utility {
    ...
    {
        return $this->uniteArrays($aFieldset, $this->_getFieldTypeDefaultArguments($aFieldset[ 'type' ], $aFieldTypeDefinitions) + WPCAC_AdminPageFramework_Form_Model___Format_Fieldset::$aStructure);
    }
    ...
    protected function _getRepeatableFieldButtons($sFieldsContainerID, $iFieldCount, $aSettings)
    {
        ...
        $_oFormatter = new WPCAC_AdminPageFramework_Form_Model___Format_RepeatableField($_aSettings, $this->oMsg);
    ...
    {
        $_aContainerAttributes = array( 'class' => $this->getClassAttribute('wpcommand-repeatable-field-buttons', ! empty($aArguments[ 'disabled' ]) ? 'disabled' : ''), );
