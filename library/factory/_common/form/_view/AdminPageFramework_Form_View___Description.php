...
class WPCAC_AdminPageFramework_Form_View___Description extends WPCAC_AdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'wpcommand-form-element-description';
