...
class WPCAC_AdminPageFramework_Form_View___DebugInfo extends WPCAC_AdminPageFramework_FrameworkUtility {
    ...
    public function get()
    {
        ...
        return "<div class='wpcommand-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
