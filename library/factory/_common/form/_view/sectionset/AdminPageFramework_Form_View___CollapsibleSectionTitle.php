...
class WPCAC_AdminPageFramework_Form_View___CollapsibleSectionTitle extends WPCAC_AdminPageFramework_Form_View___SectionTitle {
    ...
    private function ___enqueueScript()
    {
        ...
        $_oForm->addResource('src_scripts', array( 'handle_id' => 'wpcommand-script-form-collapsible-sections', ));
    }
    private function ___getCollapsibleSectionTitleBlock(array $aCollapsible, $sContainer='sections', $iSectionIndex=null)
    {
        ...
        return "<div " . $this->getAttributes(array( 'id' => $_sSectionTitleTagID, 'class' => $this->getClassAttribute('wpcommand-section-title', $this->getAOrB('box' === $aCollapsible[ 'type' ], 'accordion-section-title', ''), 'wpcommand-collapsible-title', $this->getAOrB('sections' === $aCollapsible[ 'container' ], 'wpcommand-collapsible-sections-title', 'wpcommand-collapsible-section-title'), $this->getAOrB($aCollapsible[ 'is_collapsed' ], 'collapsed', ''), 'wpcommand-collapsible-type-' . $aCollapsible[ 'type' ]), ) + $this->getDataAttributeArray($aCollapsible)) . ">" . $_sSectionTitle . "</div>";
    }
}
