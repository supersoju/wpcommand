...
class WPCAC_AdminPageFramework_Form_View___FieldsetRow extends WPCAC_AdminPageFramework_Form_View___FieldsetTableRow {
    ...
    public function get()
    {
        ...
        $_oFieldrowAttribute = new WPCAC_AdminPageFramework_Form_View___Attribute_Fieldrow($aFieldset);
