...
class WPCAC_AdminPageFramework_Debug extends WPCAC_AdminPageFramework_Debug_Log {
    ...
    {
        self::showDeprecationNotice('WPCAC_AdminPageFramework_Debug::' . __FUNCTION__, 'WPCAC_AdminPageFramework_Debug::dump()');
        WPCAC_AdminPageFramework_Debug::dump($asArray, $sFilePath);
    }
    public static function getArray($asArray, $sFilePath=null, $bEscape=true)
    {
        self::showDeprecationNotice('WPCAC_AdminPageFramework_Debug::' . __FUNCTION__, 'WPCAC_AdminPageFramework_Debug::get()');
        return WPCAC_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
    }
    public static function logArray($asArray, $sFilePath=null)
    {
        self::showDeprecationNotice('WPCAC_AdminPageFramework_Debug::' . __FUNCTION__, 'WPCAC_AdminPageFramework_Debug::log()');
        WPCAC_AdminPageFramework_Debug::log($asArray, $sFilePath);
    }
}
