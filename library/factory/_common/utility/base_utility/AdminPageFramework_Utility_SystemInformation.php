...
abstract class WPCAC_AdminPageFramework_Utility_SystemInformation extends WPCAC_AdminPageFramework_Utility_File {
    ...
    public static function getPHPErrorLog($iLines=1)
    {
