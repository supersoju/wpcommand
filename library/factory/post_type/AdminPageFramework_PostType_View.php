...
abstract class WPCAC_AdminPageFramework_PostType_View extends WPCAC_AdminPageFramework_PostType_Model {
    ...
    public function _replyToPrintStyle()
    {
        ...
        if (! empty($_sStyle)) {
            echo "<style type='text/css' id='wpcommand-style-post-type'>" . $this->oProp->sStyle . "</style>";
        }
        $this->oProp->sStyle = '';
    }
