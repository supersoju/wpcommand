...
abstract class WPCAC_AdminPageFramework_PostType_Model extends WPCAC_AdminPageFramework_PostType_Router {
    public function __construct($oProp)
    {
        ...
        if ($this->oProp->bIsAdmin) {
            ...
            if ($this->oProp->sCallerPath) {
                new WPCAC_AdminPageFramework_PostType_Model__FlushRewriteRules($this);
            }
        }
    }
    ...
    public function _replyToRegisterPostType()
    {
        ...
        new WPCAC_AdminPageFramework_PostType_Model__SubMenuOrder($this);
    }
