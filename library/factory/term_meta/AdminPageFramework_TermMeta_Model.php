...
abstract class WPCAC_AdminPageFramework_TermMeta_Model extends WPCAC_AdminPageFramework_TermMeta_Router {
    ...
    {
        $_oMetaData = new WPCAC_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
