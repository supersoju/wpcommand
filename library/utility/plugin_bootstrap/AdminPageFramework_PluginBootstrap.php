...
abstract class WPCAC_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    {
        if (! class_exists('WPCAC_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new WPCAC_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
