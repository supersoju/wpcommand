...
class WPCAC_AdminPageFramework_PointerToolTip extends WPCAC_AdminPageFramework_FrameworkUtility {
    ...
    {
        echo "<script type='text/javascript' class='wpcommand-pointer-tool-tip'>" . '/* <![CDATA[ */' . $this->___getInternalScript(self::$aPointers) . '/* ]]> */' . "</script>";
    }
